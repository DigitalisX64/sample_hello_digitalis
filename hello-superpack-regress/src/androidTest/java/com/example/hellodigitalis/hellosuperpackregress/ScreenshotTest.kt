package com.example.hellodigitalis.hellosuperpackregress
...
class ScreenshotTest {
    ...
    val rule = ScreenshotTestRule(
        "com.example.hellodigitalis.hellosuperpackregress/com.example.hellosuperpackregress.MainActivity",
        5000,
        0.05f
    )
